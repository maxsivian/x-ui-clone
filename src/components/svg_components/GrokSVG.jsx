...
import styles from "./GrokSVG.module.css"
...
const GrokSVG = () => {
    ...
    return (
        <div onMouseEnter={() => setColor("rgb(29, 155, 240)")} onMouseLeave={() => setColor("gray")} className={styles.container}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 33 32" aria-hidden="true" className="r-4qtqp9 r-yyyyoo r-dnmrzs r-bnwqim r-lrvibr r-m6rgpd r-1nao33i r-lwhw9o r-cnnz9e" fill={color}>
                <g>
