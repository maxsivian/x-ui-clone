...
import styles from "./RepostSVG.module.css"

const RepostSVG = ({ reposts = 0 }) => {

    const [color, setColor] = useState("gray")

    return (
        <div
            onMouseEnter={() => setColor("#00BC7D")} onMouseLeave={() => setColor("gray")}
        ...
        >
            ...
            <div className={styles.data}>{reposts}</div>
        </div>
    )
}
